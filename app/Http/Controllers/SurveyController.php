...
class SurveyController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return SurveyResource::collection(Survey::where('user_id', $user->id)->orderBy('created_at', 'desc')
        ->paginate(10)
    );   
    }
    ...
    public function update(SurveyUpdateRequest $request, Survey $survey)
    {
        ...
        $toAdd = array_diff($existingIds, $newIds);
    ...
    /**
     * save image on local file system and return save image path
     * 
     * @param $image
     * @return \Exception
     * @author raj <raj@test.com>
     * 
     */
     ...
     */
     private function createQuestion($data){
        ...
        $validator = Validator::make($data, [
            ...
            'descritption' => 'nullable|string',
            'data' => 'present',
            'survey_id' => 'exists:App\Models\Survey,id',
        ]);

        return SurveyQuestion::class::create($validator->validated());
    }
